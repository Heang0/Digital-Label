...
export const ReportingTab = ({
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      {/* Real Sales History Panel */}
      <div className="space-y-6">
         <div className="flex items-center gap-2 mb-2">
            <History className="h-4 w-4 text-[#5750F1]" />
            <h4 className="text-xs font-black text-[#111928] dark:text-white uppercase tracking-[0.2em]">{t('sales_history')}</h4>
         </div>
         <SalesHistoryPanel 
